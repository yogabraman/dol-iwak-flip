...
package creative.station.dol_iwak.flip;
...
public class CurlRenderer implements GLSurfaceView.Renderer {
	...
	private Vector<creative.station.dol_iwak.flip.CurlMesh> mCurlMeshes;
	private RectF mMargins = new RectF();
	private creative.station.dol_iwak.flip.CurlRenderer.Observer mObserver;
	// Page rectangles.
	 ...
	 * Basic constructor.
	 */
	public CurlRenderer(creative.station.dol_iwak.flip.CurlRenderer.Observer observer) {
		mObserver = observer;
		mCurlMeshes = new Vector<creative.station.dol_iwak.flip.CurlMesh>();
	 ...
	 */
	public synchronized void addCurlMesh(creative.station.dol_iwak.flip.CurlMesh mesh) {
		removeCurlMesh(mesh);
	 ...
	 */
	public synchronized void removeCurlMesh(creative.station.dol_iwak.flip.CurlMesh mesh) {
